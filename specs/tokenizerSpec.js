describe('Tokenizer', function() {
  ...
  it('returns an array letters in them', function() {
    var result = tokenizer('heres a few words');

    expect(result).toEqual(['h', 'e', 'r', 'e', 's', 'a', 'f', 'e', 'w', 'w', 'o', 'r', 'd', 's']);
  });
  ...
  it('treats sh as a single letter', function() {
    expect(tokenizer('shush smol sister')).toEqual(['sh', 'u', 'sh', 's', 'm', 'o', 'l', 's', 'i', 's', 't', 'e', 'r']);
  });

  it('treats th as a single letter', function() {
    expect(tokenizer('thanks totem')).toEqual(['th', 'a', 'n', 'k', 's', 't', 'o', 't', 'e', 'm']);
  });
  ...
  it('treats qu as a single letter', function() {
    expect(tokenizer('quien es el doctor')).toEqual(['qu', 'i', 'e', 'n', 'e', 's', 'e', 'l', 'd', 'o', 'c', 't', 'o', 'r']);
  });
